...
# 1 "levelBackground.h" 1
# 22 "levelBackground.h"
...
# 56 "main.c" 2
# 1 "instructionsScreenForeground.h" 1
# 22 "instructionsScreenForeground.h"
extern const unsigned short instructionsScreenForegroundTiles[48];


extern const unsigned short instructionsScreenForegroundMap[1024];


extern const unsigned short instructionsScreenForegroundPal[256];
# 57 "main.c" 2
# 1 "pauseScreen.h" 1
# 22 "pauseScreen.h"
extern const unsigned short pauseScreenTiles[1104];
...
extern const unsigned int gameBGM_sampleRate;
extern const unsigned int gameBGM_length;
extern const signed char gameBGM_data[];
# 64 "main.c" 2
...
void goToMenu() {
    ...
    DMANow(3, startScreenTiles, &((charblock *)0x6000000)[0], 3648 / 2);
...
void menu() {
    ...
    if ((!(~(oldButtons)&((1<<2))) && (~buttons & ((1<<2))))) {
        ...
        (*(volatile unsigned short*)0x400000A) = ((2)<<2) | ((27)<<8) | (0<<14) | (0<<7);
        goToInstructions();
    }
}
...
void goToInstructions() {
    ...
    DMANow(3, instructionsScreenTiles, &((charblock *)0x6000000)[0], 20224 / 2);
    DMANow(3, instructionsScreenMap, &((screenblock *)0x6000000)[28], 6144 / 2);


    DMANow(3, instructionsScreenForegroundTiles, &((charblock *)0x6000000)[2], 96 / 2);
    DMANow(3, instructionsScreenForegroundMap, &((screenblock *)0x6000000)[27], 2048 / 2);
}
...
void instructions() {
    ...
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<7))) && vOff < 320) {
        vOff++;

    }
    if (vOff == 256 && currentScreenblock == 28) {
        (*(volatile unsigned short*)0x4000008) = ((0)<<2) | ((29)<<8) | (2<<14) | (0<<7);
        vOff = 1;
...
void goToGame() {
    ...
    waitForVBlank();
    (*(volatile unsigned short*)0x4000008) = ((0)<<2) | ((31)<<8) | (0<<14) | (0<<7);
    DMANow(3, levelBackgroundPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, levelBackgroundTiles, &((charblock *)0x6000000)[0], 96 / 2);
    DMANow(3, levelBackgroundMap, &((screenblock *)0x6000000)[31], 2048 / 2);
...
void goToPause() {
    ...
    DMANow(3, pauseScreenTiles, &((charblock *)0x6000000)[0], 2208 / 2);
...
void goToWin() {
    ...
    DMANow(3, winScreenTiles, &((charblock *)0x6000000)[0], 2560 / 2);
...
void goToLose() {
    ...
    DMANow(3, loseScreenTiles, &((charblock *)0x6000000)[0], 2720 / 2);
